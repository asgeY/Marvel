...
let cardData: [Card] = [
  Card(
    title: "Batman",
    headline: "DC comic hero",
    imageName: "Bat",
    callToAction: "Hero",
    message: "Batman is the superhero protector of Gotham City, a man dressed like a bat who fights against evil and strikes terror into the hearts of criminals everywhere.",
